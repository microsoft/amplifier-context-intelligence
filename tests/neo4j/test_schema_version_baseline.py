"""Tier 3 - Neo4j integration proof for the SchemaMeta baseline singleton (§10.2).
...
still leave exactly one node) -- the whole point of BLOCKER-3's hardening
...
class TestEnsureNeo4jSchemaNoLongerWritesSchemaMeta:
    """``ensure_neo4j_schema`` must not touch :SchemaMeta at all (BLOCKER-3 follow-up).
